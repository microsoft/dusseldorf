  ...
  const refreshZones = () => {
    DusseldorfAPI.GetZones()
      .then((zones) => {
        ...
        // Filter hidden zones and sort: favorites on top, rest alphabetically
  ...
  return (
    <>
      ...
      >
        ...
        <NavDrawerBody>
          <NavItem icon={<HomeRegular fontSize={20} />} value="home">
            Home
          </NavItem>
          <NavSectionHeader>
          ...
          <NavCategory value="templates">
            <NavCategoryItem icon={<WindowEditRegular fontSize={20} />}>
              Templates
            </NavCategoryItem>
            <NavSubItemGroup>
              ...
              <NavSubItem value="psimdskeyvault">
                Powershell IMDS AKV Exfil
              </NavSubItem>
          ...
          <NavItem value="zones" icon={<TargetRegular fontSize={20} />}>
            All Zones
          </NavItem>
          <NavCategory value="zones">
            <NavCategoryItem icon={<TargetEditRegular fontSize={20} />}>
              Zones
            </NavCategoryItem>

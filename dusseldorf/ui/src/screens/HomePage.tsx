...
export const HomePage = () => {
  ...
  const [recentZones, setRecentZones] = useState<Zone[]>(
    CacheHelper.GetZones(),
  );
  ...
  return (
    ...
    >
      <div className="stack hstack-spread" style={{ paddingBottom: "30px" }}>
        <div className="stack vstack-gap">
          <Title2>Project Dusseldorf</Title2>

          {recentZones.length > 0 ? (
            <Text>
              Create a new DNS zone, or open a recent one to pick up where you
              left off.
            </Text>
          ) : (
            // or
      ...
      <div className="stack vstack-gap">
        <Text>
          Dusseldorf is a platform for analyzing out-of-band network requests to
          detect security vulnerabilities at scale. It is intented to help with
          application security research. If you are unsure if you should be
          using this software, please contact your security team or contact us
          on:{" "}
          <Link inline href="mailto:dusseldorf@microsoft.com">
        ...
        <Text>
          This platform is used to automatically detect and dissect network
          traffic and iteratively manipulate its responses with custom payloads
          to ease further analysis and exploitation. This process helps in
          exploring, researching and exploiting cloud vulnerabilities such as{" "}
          <abbr title="Server Side Request Forgery">SSRF</abbr>,{" "}
        ...
        <Text>
          ...
          <abbr title="Fully Qualified Domain Name">FQDN</abbr> subdomains) to
          determine the routing of network requests. This way, only you can see
          what is sent to your zones, or you can setup strong{" "}
          <abbr title="Role Based Access Control">RBAC</abbr> rules to provide
          granular access to other to collaborate.
        </Text>

        <Text>
          For more information and information on how to get started, go to{" "}
          <Link href="https://github.com/microsoft/dusseldorf" inline>

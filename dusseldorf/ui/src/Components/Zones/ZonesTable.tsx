...
export const ZonesTable = ({ refreshZones, zones }: ZonesTableProps) => {
  ...
  const columns: TableColumnDefinition<Zone>[] = [
    createTableColumn<Zone>({
      ...
      renderHeaderCell: () => {
        return <Body1Strong className={styles.fqdnColumn}>FQDN</Body1Strong>;
      },
      renderCell: (zone) => {
        return (
          <DataGridCell className={styles.fqdnColumn}>
            <Caption1>{zone.fqdn.replace("." + zone.domain, "")}</Caption1>
    ...
    createTableColumn<Zone>({
      ...
      renderHeaderCell: () => {
        return (
          <Body1Strong className={styles.domainColumn}>Domain</Body1Strong>
        );
      },
      renderCell: (zone) => {
        return (
          <DataGridCell className={styles.domainColumn}>
            <Caption1>{zone.domain}</Caption1>
          </DataGridCell>
        );
      },
    }),
    createTableColumn<Zone>({
      ...
      renderHeaderCell: () => {
        return (
          <Body1Strong className={styles.actionsColumn}>Actions</Body1Strong>
        );
      },
      renderCell: (zone) => {
        return (
    ...
    createTableColumn<Zone>({
      columnId: "pinColumn",
      renderHeaderCell: () => {
        return <Body1Strong>Pin</Body1Strong>;
      },
      renderCell: (zone) => {
        ...
        return (
          <DataGridCell style={{ paddingLeft: 5, paddingRight: 5 }}>
            <Tooltip
              content={`${isFavorite ? "Unpin" : "Pin"} ${zone.fqdn}`}
              relationship="label"
            >
              <Button
                appearance="subtle"

...
const allColumns: TableColumnDefinition<DssldrfRequest>[] = [
    ...
    createTableColumn<DssldrfRequest>({
        ...
        renderCell: (request) => {
            ...
            let color = "inherit";
            if (code >= 200 && code < 300) color = tokens.colorPaletteGreenForeground1;
            else if (code >= 300 && code < 400) color = tokens.colorPaletteDarkOrangeForeground1;
            else if (code >= 400 && code < 500) color = tokens.colorPaletteRedForeground1;
            else if (code >= 500 && code < 600) color = tokens.colorPalettePurpleForeground2;
            return (

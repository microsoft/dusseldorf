...
> This project is often stylized as *duSSeldoRF*, following a common practice [within Microsoft](https://en.wikipedia.org/wiki/List_of_Microsoft_codenames) to use place names as project names.  The beautiful city Düsseldorf is one of the few places in the world with the letters *SSRF* in its name.  For ease of use we substituted the umlaut character (alt-0252) ü for a normal u.
